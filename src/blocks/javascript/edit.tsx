...
import { IconBrandJavascript, IconChevronLeft, IconWindowMaximize } from '@tabler/icons-react'
...
import { Box, Button, Group, SetupEditorEnv, SourceSelect, Text } from '../../components'
...
function EditComponent(props: BlockEditProps<Attributes>) {
	...
	const [activeTab, setActiveTab] = useState<string | null>('JavaScript')
	const sources = useDiscover({ contentTypeFilter: activeTab === 'JavaScript' ? 'javascript' : undefined })
			...
			{isWizardMode ? (
				<Box p="md" style={{ border: '1px solid #000' }}>
					<Group mb="md" spacing={0}>
						...
						<Text ml="xs" fz={24}>
							{__('JavaScript Code', 'inseri-core')}
						</Text>
					</Group>
					{wizardStep === 0 && (
						<Group mb="md" spacing={0}>
