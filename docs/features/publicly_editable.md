...
As a concrete example, please see the [Python Code Block using Pyodide](https://zi.uzh.ch/whp/science-it/inseri/2023/02/python-code-block-using-pyodide/){:target="\_blank"}.
