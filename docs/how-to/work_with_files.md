...
[Python and Matplotlib](https://zi.uzh.ch/whp/science-it/inseri/2023/06/python-and-matplotlib/){:target="\_blank"} shows an example on how to share a binary file between two blocks.
...
For an example please see [Global Student Visa Cost](https://zi.uzh.ch/whp/science-it/inseri/2024/05/global-student-visa-cost/){:target="\_blank"}.
