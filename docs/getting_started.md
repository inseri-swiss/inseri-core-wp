...
Alternatively you can check out the functionalities in the [inseri Playground](https://zi.uzh.ch/whp/science-it/inseri/playground/){:target="\_blank"}. Please see [How to use inseri Playground](./how-to/playground.md){:target="\_blank"}.
